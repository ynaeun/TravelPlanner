...
app.get('/api/festivals', async (req, res) => {
  try {
    const response = await axios.get('http://apis.data.go.kr/B551011/EngService1/searchFestival1?eventStartDate=20250601&eventEndDate=20281231&areaCode=&sigunguCode=&ServiceKey=%2BWnLF9LEv2%2BFlnclGOqrnMap89wzaDIicevOjW0I9AkKnEUYsPAWTfb1A8h21ycHoCZhrwKw3PPO%2Bj4wDvqdAw%3D%3D&listYN=Y&MobileOS=ETC&MobileApp=AppTest&arrange=A&numOfRows=1000', {
      params: {
